<template lang="">
  <!-- Footer container -->
  <div class="dark:bg-[#222431]">
    <footer
      class="bg-neutral-100 text-center text-neutral-600 dark:bg-[#222431] dark:text-neutral-200 lg:text-left"
    >
      <div
      ...
      <!--Copyright section-->
      <div class="bg-neutral-200 p-6 text-center dark:dark:bg-[#2f3034]">
